    ...
    (function () {
        function Tree (params){
            ...
            for(var i = 0; i < this.treeScheme.length; i++){
                ...
                //this.treeScheme.push(treeObject)
            }
            ...
            this.RenderTreeItem(this.topElementl,this.treeContainer)
        }
        ...
        Tree.prototype.RenderTreeItem = function(item,container){
            var treeItemContainer = container.createChild("otc-tree-view__tree-item-container")
            var treeItemTitleContainer = treeItemContainer.createChild("otc-tree-view__tree-item-title-container")
            var treeItemChildrenContainer = treeItemContainer.createChild("otc-tree-view__tree-item-children-container")
        }
