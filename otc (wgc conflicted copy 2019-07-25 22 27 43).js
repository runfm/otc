...
(function (Controls) {
    ...
    (function () {
        function Field(params) {
            ...
            if (this instanceof Controls.ComboBox || this instanceof Controls.Box) {
    ...
    (function () {
        function Control(params) {
            ...
            this.__value__ = "";
            this.isValid = (this.validationRule.Type) ? false : true //Начальное значение 

            var wrapper = this.container.createChild({
                className: "otc-control__wrapper",
                attributes: {
                    "otc-mandatory": this.validationRule.ErrorMessage
                }
            });
    ...
    (function () {
        function InputNumberControl(params) {
            ...
            this.inputElement = this.container.createChild({
                ...
                eventListeners: {
                    ...
                    change: function () {
                        return InputNumber_OnInputElementChange.call(self);
                    },
                    click: function(){
        ...
        InputNumberControl.prototype.Check = function (checkAll) {
            ...
            if (this.leadingZeroesFrom && enteredNumber >= leadingZeroesFrom && this.value.length < this.maxLength) {
                ...
                for (var i = 0; i < leadZeroesCount; i++)
                    leadZeroesString += "0"
                console.log("1",leadZeroesString + enteredNumber)
                this.value = leadZeroesString + enteredNumber
                console.log("2",this.inputElement.value)
            }
        ...
        function InputNumber_OnBlur(e) {
            console.log("4",this.value, this.inputElement.value)
            this.Check(true)
            console.log("5",this.value, this.inputElement.value)
        ...
        function InputNumber_OnInputElementChange(e) {
/*             this.Check(true)
            console.log("3",this.inputElement.value)
            this.value = this.inputElement.value
            this.onChange && this.onChange() */
        }
    ...
    (function () {
        ...
        Box.prototype.UpdateValue = function () {
            ...
            if (this.selectedItems.length)
                this.clearBtnContainer.hidden = false
            this.SetValue(value)
        };
