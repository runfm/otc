...
(function (Controls) {
    ...
    (function () {
        function Grid(params) {
            Controls.Control.call(this, params);
            var self = this;
            this.contentContainer = this.contentWrapper.createChild("otc-grid__table-container");
        ...
        Grid.prototype.insertRow = function () {
            ...
            for (var i = 0; i < this.columns.length; i++) {
                ...
                switch (this.columns[i].Type) {
                    case "Text":
                        newDataCell.customInput = newDataCell.createChild({
                            tagName: "input",
                            eventListeners: {
                                change: OnGrid__CustomInputChange
                            }
                        });
                        break;
                    case "Date":
                        newDataCell.customInput = new otCustom.Controls.Date({
                            ...
                            onChange: OnGrid__CustomInputChange
                        })
                        break;
                    case "Choice":
                ...
                //newDataCell.textContent =  this.columns[i].Title
            }
        }
