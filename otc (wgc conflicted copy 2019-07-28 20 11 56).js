...
(function (Controls) {
    ...
    (function () {
        function Tree(params) {
            ...
            this.RenderTreeItem(this.topElement, this.treeContainer,1)
        }
        ...
        function OnTreeViewContainerClick(e) {
            ...
            if (e.target.className == "otc-tree-view__tree-item-title-container" && e.target.nextElementSibling) {
                ...
                e.target.setAttribute("otc-childs-hidden", e.target.nextElementSibling.hidden)

                var nestedSelectedContainer = e.target.querySelector(".otc-tree-view__tree-item-nested-added-count")
                if (e.target.nextElementSibling.hidden) {
                    var nestedSelectedDOM = e.target.nextElementSibling.querySelector("[otc-tree-added=true]")
